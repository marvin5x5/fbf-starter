...
| 7 | Setup | fbf-starter is not a git repo → the branch/PR sign-off ritual (step 3) can't run yet | Deferred by decision | Yes — §handoff: "init the repo before the sign-off flow" |
